...
var Button = styled__default.button(_templateObject(), function (props) {
  ...
  return props.theme.button.textDecoration;
}, function (props) {
  return props.theme.button.cursor;
});
Button.propTypes = {
...
var LAYOUTS = {
  ALTERNATE_EVENTS: 'alt-evts',
  ALTERNATE_EVENTS_INLINE_DATE: 'alt-evts-inline-date',
  INLINE_EVENTS: 'inline-evts',
  INLINE_EVENTS_INLINE_DATE: 'inline-evts-inline-date'
};
...
var Events = styled__default.div.attrs(function (_) {
  return {
    className: 'events'
  };
})(_templateObject$1(), function (props) {
  return props.theme.events.padding;
...
function createTheme(baseTheme, newTheme) {
  return lodash_merge({}, baseTheme, newTheme);
}

var roliTheme = createTheme(defaultTheme, {
  timeline: {
...
var TimelineContext = React__default.createContext();
...
var OverflowWrapper = styled__default.div(_templateObject$2());
var Container = styled__default.div(_templateObject2(), function (props) {
  return props.theme.timeline.fontSize;
}, function (props) {
  return props.theme.timeline.fontFamily;
}, function (props) {
  return props.theme.timeline.backgroundColor;
}, function (props) {
  return props.theme.timelineTrack.left;
}, function (props) {
  return props.theme.timelineTrack.width;
}, function (props) {
  return props.theme.timelineTrack.height;
}, function (props) {
  return props.theme.timelineTrack.backgroundColor;
}, function (props) {
  return props.theme.timelineTrack.content;
...
function Timeline(_ref) {
  ...
  if (opts && lodash_isplainobject(opts)) {
    finalOpts = lodash_merge(finalOpts, opts);
  }

  var classNames = joinClassNames(['timeline', 'overflow-wrapper', className]);
  var inlineDate = finalOpts.layout.toLowerCase().includes('in-date');
  return React__default.createElement(styled.ThemeProvider, {
    theme: theme || themes["default"]
  }, React__default.createElement(OverflowWrapper, {
    className: classNames
  }, React__default.createElement(Container, {
    className: "timeline container ".concat(finalOpts.layout)
  }, React__default.createElement(TimelineContext.Provider, {
    value: {
      opts: finalOpts,
...
var Image = styled__default.img(_templateObject$3(), function (props) {
  return props.theme.imageAtom.objectFit;
}, function (props) {
  return props.theme.imageAtom.width;
}, function (props) {
  return props.theme.imageAtom.maxHeight;
});
function ImageAtom(_ref) {
  var src = _ref.src,
      alt = _ref.alt;
...
var Container$1 = styled__default.div(function (props) {
  return props.theme.textAtom;
});
function TextAtom(_ref) {
  var text = _ref.text;
  return React__default.createElement(Container$1, {
    className: "text-atom"
  }, React__default.createElement(MarkdownAtom, {
    text: text
  }));
}
TextAtom.propTypes = {
...
var Loading = styled__default.div(function (props) {
  var defaults = {
    width: '100%',
    height: '200px',
    backgroundColor: '#fff'
  ...
  var style = _objectSpread2({}, defaults, {}, props.theme.twitterAtomLoading);

  return style;
});
var Tweet = styled__default.div(function (props) {
  var defaults = {
    '.twitter-tweet': {
      width: '100% !important'
    }
  ...
  var style = _objectSpread2({}, defaults, {}, props.theme.twitterAtom);
...
function TweetAtom(_ref) {
  var id = _ref.id,
      tweetOpts = _ref.tweetOpts;
  ...
  React.useEffect(function () {
    window.twttr.widgets.createTweet(id, document.querySelector(".tweet[data-id=\"".concat(id, "\"]")), tweetOpts).then(function (_) {
      setLoading(false);
    });
  }, [id, tweetOpts]);
  return React__default.createElement(React__default.Fragment, null, loading && React__default.createElement(Loading, {
    className: "tweet-loading"
  }), React__default.createElement(Tweet, {
    className: "tweet",
    "data-id": id
  }));
}
...
var Container$2 = styled__default.div(function (props) {
  var defaults = {
    position: 'relative',
    overflow: 'hidden',
    paddingBottom: '56.25%'
  ...
  var style = _objectSpread2({}, defaults, {}, props.theme.youTubeAtom);

  return style;
});
var RespIframe = styled__default.iframe(_templateObject$4());
function YouTubeAtom(_ref) {
  var id = _ref.id,
      name = _ref.name;
...
var DateContainer = styled__default.div(_templateObject$5(), LAYOUTS.ALTERNATE_EVENTS_INLINE_DATE, LAYOUTS.INLINE_EVENTS_INLINE_DATE, LAYOUTS.ALTERNATE_EVENTS_INLINE_DATE, LAYOUTS.INLINE_EVENTS_INLINE_DATE);
var Date$1 = styled__default.time(_templateObject2$1(), function (props) {
  return props.theme.date.backgroundColor;
}, function (props) {
  return props.theme.date.padding;
}, function (props) {
  return props.theme.date.color;
}, function (props) {
  return props.theme.date.borderRadius;
}, function (props) {
  return props.theme.date.fontWeight;
}, function (props) {
  return props.theme.date.fontSize;
});
function EventDate(_ref) {
  var date = _ref.date,
      inline = _ref.inline,
      layout = _ref.layout;
  ...
  var containerClassNames = joinClassNames(['date-container', inline ? 'inline' : null, layout]);
  var dateClassNames = joinClassNames(['date', inline ? 'inline' : null]);
  return React__default.createElement(DateContainer, {
...
var Container$3 = styled__default.span(_templateObject$6(), function (props) {
  return props.theme.marker.backgroundColor;
}, function (props) {
  return props.theme.marker.border;
}, function (props) {
  return props.theme.marker.borderRadius;
}, function (props) {
  return props.theme.marker.borderColor;
}, function (props) {
  return props.theme.marker.width;
}, function (props) {
  return props.theme.marker.height;
});
function Marker() {
...
var Container$4 = styled__default.div(_templateObject$7(), function (props) {
  return props.theme.card.borderRadius;
}, function (props) {
  return props.theme.card.backgroundColor;
}, function (props) {
  return props.theme.card.color;
}, function (props) {
  return props.theme.card.padding;
}, function (props) {
  return props.theme.card.boxShadow;
}, function (props) {
  return props.theme.card.width;
}, function (props) {
  return props.theme.card.maxWidth;
}, function (props) {
  return props.theme.card.a.color;
}, function (props) {
  return props.theme.urlButton.fontSize;
}, function (props) {
  return props.theme.urlButton.backgroundColor;
}, function (props) {
  return props.theme.urlButton.border;
}, function (props) {
  return props.theme.urlButton.borderRadius;
}, function (props) {
  return props.theme.urlButton.padding;
}, function (props) {
  return props.theme.urlButton.margin;
}, function (props) {
  return props.theme.urlButton.color;
});
function Card(_ref) {
  var date = _ref.date,
      children = _ref.children;

  var _useContext = React.useContext(TimelineContext),
  ...
  if (date) {
    if (typeof date === 'string') {
      DateComponent = React__default.createElement(EventDate, {
        date: date,
        layout: layout,
        inline: true
      });
      ...
      DateComponent = React__default.cloneElement(date, {
        layout: layout,
        inline: true
      });
    }
  ...
  return React__default.createElement(Container$4, {
    className: joinClassNames(['card', layout])
  }, DateComponent, children);
}
Card.propTypes = {
  date: propTypes.oneOfType([propTypes.string, propTypes.func, propTypes.element]).isRequired,
  children: propTypes.node.isRequired
};

var _styled$div, _styled$div2;
var Container$5 = styled__default.div(function (props) {
  var _defaults;
  ...
  }, _defineProperty(_defaults, "&.".concat(LAYOUTS.INLINE_EVENTS, ", &.").concat(LAYOUTS.INLINE_EVENTS_INLINE_DATE), {
    flexDirection: 'row !important'
  }), _defineProperty(_defaults, '@media (max-width: 768px)', {
    flexDirection: 'row !important'
  }), _defaults);

  var style = _objectSpread2({}, defaults, {}, props.theme.event);

  return style;
});
var DateColumn = styled__default.div((_styled$div = {
  display: 'flex',
  ...
  alignItems: 'flex-end',
  zIndex: 300
}, _defineProperty(_styled$div, "&.".concat(LAYOUTS.ALTERNATE_EVENTS), _defineProperty({}, "".concat(Container$5, ":nth-child(even) &"), {
  alignItems: 'flex-start'
})), _defineProperty(_styled$div, "&.".concat(LAYOUTS.INLINE_EVENTS), {
  flexBasis: '100px',
  justifyContent: 'center',
  alignItems: 'flex-end'
}), _defineProperty(_styled$div, "&.".concat(LAYOUTS.INLINE_EVENTS_INLINE_DATE), {
  flexBasis: 0,
  justifyContent: 'center',
  alignItems: 'flex-end'
}), _defineProperty(_styled$div, '@media (max-width: 768px)', {
  flexBasis: '0 !important'
}), _styled$div));
var MarkerColumn = styled__default.div({
  display: 'flex',
  flexDirection: 'column',
  justifyContent: 'center',
  alignItems: 'center',
...
var CardColumn = styled__default.div((_styled$div2 = {
  display: 'flex',
  flexDirection: 'column',
  justifyContent: 'flex-start',
  flexBasis: '50%',
  flexGrow: '1'
}, _defineProperty(_styled$div2, "&.".concat(LAYOUTS.ALTERNATE_EVENTS, ", &.").concat(LAYOUTS.ALTERNATE_EVENTS_INLINE_DATE), _defineProperty({}, "".concat(Container$5, ":nth-child(even) &"), {
  alignItems: 'flex-end'
})), _defineProperty(_styled$div2, '@media (max-width: 768px)', {
...
function Event(_ref) {
  ...
  if (typeof marker === 'function') {
    ...
    MarkerComponent = React__default.createElement(Marker, {
      layout: layout
    });
  }
  ...
  if (typeof card === 'function') {
    ...
    CardComponent = React__default.createElement(Card, {
      date: date,
      children: children
    });
  }

  var classNames = joinClassNames(['event', className, layout]);
  return React__default.createElement(Container$5, {
    className: classNames
  }, React__default.createElement(DateColumn, {
    className: "date-col ".concat(layout)
  }, DateComponent), React__default.createElement(MarkerColumn, {
    className: "marker-col ".concat(layout)
  }, MarkerComponent), React__default.createElement(CardColumn, {
    className: "card-col ".concat(layout)
  }, CardComponent));
}
Event.propTypes = {
  date: propTypes.oneOfType([propTypes.string, propTypes.func, propTypes.element]).isRequired,
...
var ImageTextContainer = styled__default.div(_templateObject$8(), function (props) {
  return props.theme.imageText.marginBottom;
}, function (props) {
  return props.theme.imageText.fontSize;
});
var ImageCreditContainer = styled__default.div(_templateObject2$2(), function (props) {
  return props.theme.imageCredit.marginTop;
}, function (props) {
  return props.theme.imageCredit.fontSize;
});

function ImageCredit(_ref) {
  var text = _ref.text;
  return React__default.createElement(ImageCreditContainer, null, React__default.createElement(MarkdownAtom, {
    text: text
  }));
}

function ImageText(_ref2) {
  var text = _ref2.text;
  return React__default.createElement(ImageTextContainer, null, React__default.createElement(MarkdownAtom, {
    text: text
  }));
}
/**
...
function ImageEvent(props) {
  var date = props.date,
      ...
      card = props.card;
  return React__default.createElement(Event, {
    className: joinClassNames(['image-event', className]),
    date: date,
    marker: marker,
    card: card
  }, text && React__default.createElement(ImageText, {
    className: "image-text",
    text: text
  }), React__default.createElement(ImageAtom, {
    src: src,
    alt: alt
  }), credit && React__default.createElement(ImageCredit, {
...
function TextEvent(props) {
  ...
  return React__default.createElement(Event, {
    ...
    marker: marker,
    card: card
  }, React__default.createElement(TextAtom, {
    text: text
  }), children);
}
TextEvent.propTypes = {
...
var TweetText = styled__default(TextAtom)(function (props) {
  var defaults = {};

  var style = _objectSpread2({}, defaults, {}, props.theme.tweetText);

  return style;
});
function TweetEvent(props) {
  var date = props.date,
      id = props.id,
      text = props.text,
      marker = props.marker,
      tweetOpts = props.tweetOpts,
      children = props.children,
      className = props.className,
      card = props.card;
  return React__default.createElement(Event, {
    ...
    marker: marker,
    card: card
  }, text && React__default.createElement(TweetText, {
    className: "tweet-text",
    text: text
  }), React__default.createElement(TweetAtom, {
    id: id,
    tweetOpts: tweetOpts
  }), children);
}
...
var YouTubeTextContainer = styled__default.div(_templateObject$9(), function (props) {
  return props.theme.youTubeText.marginBottom;
}, function (props) {
  return props.theme.youTubeText.fontSize;
});

function YouTubeText(_ref) {
  var text = _ref.text;
  return React__default.createElement(YouTubeTextContainer, null, React__default.createElement(MarkdownAtom, {
    text: text
  }));
}

function YouTubeEvent(props) {
  var date = props.date,
      id = props.id,
      name = props.name,
      text = props.text,
  ...
  return React__default.createElement(Event, {
    ...
    marker: marker,
    card: card
  }, text && React__default.createElement(YouTubeText, {
    className: "youtube-text",
    text: text
  }), React__default.createElement(YouTubeAtom, {
    id: id,
    name: name
  }), children);
}
